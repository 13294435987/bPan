package onem.baymax.pan.web.log;
 ...
 * HttpLogEntity构造器
 *
 * @author hujiabin wrote in 2024/3/12 21:50
 */
public class HttpLogEntityBuilder {
     ...
     * @return 日志对象
     */
    public static HttpLogEntity build(ContentCachingRequestWrapper requestWrapper, ContentCachingResponseWrapper responseWrapper,
                                      StopWatch stopWatch) {
