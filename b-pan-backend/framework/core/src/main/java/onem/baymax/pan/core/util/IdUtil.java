 ...
 * 全局ID生成器, 基于雪花算法
 *
 * @author hujiabin wrote in 2024/3/12 21:25
 */
@UtilityClass
...
public class IdUtil {
    ...
    public static Long decrypt(String decryptId) {
        if (StringUtils.isNotBlank(decryptId)) {
            ...
            throw new BPanBusinessException("AES128Util.aesDecode fail");
        }
        throw new BPanBusinessException("the decryptId can not be empty");
    }
