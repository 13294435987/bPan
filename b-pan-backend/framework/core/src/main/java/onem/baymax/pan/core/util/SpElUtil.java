...
public class SpElUtil {
    ...
    private static final BPanExpressionEvaluator expressionEvaluator = new BPanExpressionEvaluator();
    ...
    @Data
    @AllArgsConstructor
    private static class BPanExpressionRootObject {
     ...
     */
    @Data
    private static class BPanExpressionEvaluator extends CachedExpressionEvaluator {
        ...
        private EvaluationContext createEvaluationContext(String className,
            ...
            BPanExpressionRootObject root = new BPanExpressionRootObject(className, methodName, classType, method, args, parameterTypes, target);
