...
/**
 * @author hujiabin
 * @description 针对表【b_pan_share_file(用户分享文件表)】的数据库操作Service实现
 * @createDate 2024-03-14 11:26:35
 */
@Service
public class BPanShareFileServiceImpl extends ServiceImpl<BPanShareFileMapper, BPanShareFile>
        implements BPanShareFileService {
