package onem.baymax.pan.server.module.file.vo;

import com.fasterxml.jackson.databind.annotation.JsonSerialize;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;
import lombok.Data;
import onem.baymax.pan.web.serializer.Date2StringSerializer;
 ...
 * 用户查询文件列表相应实体
 *
 * @author hujiabin wrote in 2024/3/19 17:52
 */
@Data
@ApiModel(value = "文件列表相应实体")
public class BPanUserFileVo implements Serializable {
